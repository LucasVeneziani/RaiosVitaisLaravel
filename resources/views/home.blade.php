...
<body class="bg-[url({{ asset('assets/img/fundo.png') }})] bg-fixed bg-contain font-[Cinzel_Decorative] scroll-smooth min-h-screen">
    <!-- Navbar -->
                ...
                <ul class="flex flex-col lg:flex-row items-center justify-end gap-2 text-pink-400 text-lg font-semibold border-2 rounded-4xl bg-neutral-secondary-soft lg:space-x-8 rtl:space-x-reverse lg:border-0 lg:bg-neutral-primary p-4 lg:p-0 ml-4 mr-4 mt-2 mb-2">
                    ...
                    <li>
                        <a href="https://wa.me/+5511992179843" class="flex items-center justify-center text-center text-white bg-pink-500/80 hover:bg-pink-500 rounded-4xl md:rounded-full shadow-md px-4 py-2">
                            <img class="hidden lg:flex size-7 mr-2" src="{{ asset('assets/img/calendario.png') }}" alt="Ícone de calendário para agendamento">
            ...
            <div class="relative h-73 lg:h-110 overflow-hidden bg-linear-to-r from-rose-400/50 via-rose-100/50 to-white/50">
                ...
                <article class="hidden duration-1000 ease-in-out" data-carousel-item="active">
                    <div class="flex flex-row items-center justify-center h-full w-full">
                        ...
                        <div class="hidden md:flex w-full lg:w-1/2 justify-center">
                            <img class="max-h-full w-auto object-contain" src="{{ asset('assets/img/slide1.jpg') }}" alt="Mulher relaxando durante um tratamento facial" loading="lazy"/>
                        </div>
                    </div>
                </article>
                <!-- Item 2 -->
                <article class="hidden duration-1000 ease-in-out" data-carousel-item>
                    <div class="flex flex-row items-center justify-center h-full w-full">
                        ...
                        <div class="hidden md:flex w-full lg:w-1/2 justify-center">
                            <img class="max-h-full w-auto object-contain" src="{{ asset('assets/img/slide2.jpg') }}" alt="Profissional aplicando tratamento estético em cliente" loading="lazy"/>
                        </div>
                    </div>
                </article>
                <!-- Item 3 -->
                <article class="hidden duration-1000 ease-in-out" data-carousel-item>
                    <div class="flex flex-row items-center justify-center h-full w-full">
                        ...
                        <div class="hidden md:flex w-full lg:w-1/2 justify-center">
                            <img class="max-h-full w-auto object-contain" src="{{ asset('assets/img/slide3.jpg') }}" alt="Mulher sorrindo após um tratamento de beleza" loading="lazy"/>
                        </div>
                    </div>
                </article>
            </div>
            ...
            <div class="flex flex-col items-center justify-center rounded-lg w-full xl:w-5/6 mt-2 mb-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center gap-8 py-2 px-4 mt-6 w-9/10">
                    <article class="flex-1 bg-white/50 rounded-lg shadow-md p-4">
                        ...
                        <img class="size-auto rounded-lg mt-2" src="{{ asset('assets/img/servico1.jpg') }}" alt="Pessoa recebendo massagem relaxante nas costas" loading="lazy">
                    ...
                    <article class="flex-1 bg-white/50 rounded-lg shadow-md p-4">
                        ...
                        <img class="size-auto rounded-lg mt-2" src="{{ asset('assets/img/servico2.jpeg') }}" alt="Tratamento facial com aplicação de máscara" loading="lazy">
                        <p class="text-rose-500 font-semibold mt-2">
                    ...
                    <article class="flex-1 bg-white/50 rounded-lg shadow-md p-4">
                        ...
                        <img class="size-auto rounded-lg mt-2" src="{{ asset('assets/img/servico3.jpeg') }}" alt="Pés recebendo tratamento de spa" loading="lazy">
                        <p class="text-rose-500 font-semibold mt-2">
                    ...
                    <article class="flex-1 bg-white/50 rounded-lg shadow-md p-4">
                        ...
                        <img class="size-auto rounded-lg mt-2" src="{{ asset('assets/img/slide1.jpg') }}" alt="Pessoa recebendo massagem relaxante" loading="lazy">
                        <p class="text-rose-500 font-semibold mt-2">
                    ...
                    <article class="flex-1 bg-white/50 rounded-lg shadow-md p-4">
                        ...
                        <img class="size-auto rounded-lg mt-2" src="{{ asset('assets/img/slide2.jpg') }}" alt="Pele hidratada e suave" loading="lazy">
                        <p class="text-rose-500 font-semibold mt-2">
                    ...
                    <article class="flex-1 bg-white/50 rounded-lg shadow-md p-4">
                        ...
                        <img class="size-auto rounded-lg mt-2" src="{{ asset('assets/img/slide3.jpg') }}" alt="Limpeza de pele profunda" loading="lazy">
                        <p class="text-rose-500 font-semibold mt-2">
             ...
             <div class="flex flex-col items-center justify-center w-full mt-2 mb-2" id="profissionais">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center gap-8 py-2 px-4 mt-6 w-9/10">
                    <article class="flex flex-col items-center bg-white/50 rounded-lg shadow-md p-4">
                        <img class="size-7/10 rounded-full border-4 border-red-300 mt-2" src="{{ asset('assets/img/profissional1.jpg') }}" alt="Foto da profissional Fernanda, pedóloga" loading="lazy">
                    ...
                    <article class="flex flex-col items-center bg-white/50 rounded-lg shadow-md p-4">
                        <img class="size-7/10 rounded-full border-4 border-red-300 mt-2" src="{{ asset('assets/img/profissional2.jpg') }}" alt="Foto da profissional Alice, esteticista" loading="lazy">
                    ...
                    <article class="flex flex-col items-center bg-white/50 rounded-lg shadow-md p-4">
                        <img class="size-7/10 rounded-full border-4 border-red-300 mt-2" src="{{ asset('assets/img/profissional3.jpg') }}" alt="Foto da profissional Debora, massagista" loading="lazy">
    ...
    <footer class="shadow-md w-full" id="contato">
        <div class="grid grid-cols-1 lg:grid-cols-2 items-center justify-center w-full mt-8 mb-2">
            <div class="flex flex-col items-center justify-center bg-linear-to-r from-rose-400/50 via-rose-300/50 to-rose-100/50 w-full h-full mt-2 mb-2">
                ...
                <div class="flex items-start justify-center w-full md:w-2/3 gap-4 mt-4 mb-2">
                    <aside class="hidden md:flex flex-col items-start justify-start">
                        <img class="size-20 inline-block mr-2" src="{{ asset('assets/img/telefone.png') }}" alt="Ícone de telefone" loading="lazy">
                        <img class="size-20 inline-block mr-4" src="{{ asset('assets/img/email.png') }}" alt="Ícone de e-mail" loading="lazy">
                        <img class="size-20 inline-block mr-4" src="{{ asset('assets/img/gps.png') }}" alt="Ícone de localização" loading="lazy">
                    </aside>
                ...
                <div class="flex items-center justify-center text-center gap-12 px-4 w-full">
                    <a class="flex items-center justify-center text-center" href="https://www.instagram.com/raiosvitais/">
                        <img class="size-20 inline-block" src="{{ asset('assets/img/instagram.png') }}" alt="Ícone do Instagram" loading="lazy">
                    ...
                    <a class="flex items-center justify-center text-center" href="https://wa.me/+5511992179843">
                        <img class="size-20 inline-block" src="{{ asset('assets/img/whatsapp.png') }}" alt="Ícone do WhatsApp" loading="lazy">
                    ...
                    <a class="flex items-center justify-center text-center" href="https://www.facebook.com/raiosvitais">
                        <img class="size-20 inline-block" src="{{ asset('assets/img/facebook.png') }}" alt="Ícone do Facebook" loading="lazy">
            ...
            <div class="hidden lg:flex items-center justify-end">
                <img class="size-auto" src="{{ asset('assets/img/clinica.jpg') }}" alt="Fachada da clínica Raios Vitais" loading="lazy">
            </div>
        </div>
